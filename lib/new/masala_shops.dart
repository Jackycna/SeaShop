...
class MassaledShops extends StatefulWidget {
  const MassaledShops({super.key});

  @override
  OwnerDetailsPageState createState() => OwnerDetailsPageState();
}

class OwnerDetailsPageState extends State<MassaledShops> {
  ...
  Future<void> fetchShops() async {
    ...
    QuerySnapshot snapshot = await _firestore
        .collection('owners')
        .where('storetype', isEqualTo: 'Massaled Shops')
        .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          LocalizationService().translate('Shops'),
      ...
      body: _isLoading
          ...
          : _shops.isEmpty
              ? const Center(child: Text('No Massaled available.'))
              : ListView.builder(
